...
class Rosenbrock_PSO:
    ...
    def train(self, max_iterations=1000):
        self.fitness = self.rosenbrock_function(self.particles)  # Ilk uygunluk degerleri
        ...
        while self.iteration < max_iterations and self.gbest[-1] >= 1e-6:  # Belirli bir uygunluk degerine ulasana kadar devam et
            self.iteration += 1
            self.fitness = self.rosenbrock_function(self.particles)  # Her iterasyonda uygunluk hesapla
...
# Rosenbrock fonksiyonu icin PSO'yu calistirma
pso_object = Rosenbrock_PSO(-2, 2, 50, 2, 2, 2)  # 2 boyutlu Rosenbrock fonksiyonu
